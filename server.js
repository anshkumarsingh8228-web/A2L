...
app.get('/',(req,res)=>{
  ...
  if(!html.includes('realmatch.js'))html=html.replace('<script src="/js/chat-realtime.js"></script></body>','<script src="/js/realmatch.js"></script><script src="/js/chat-realtime.js"></script></body>');
