...
function sendMessage(id){
 ...
 const peer=friends.find(f=>Number(f.id)===Number(id));
 if(window.a2lSocket?.connected && peer?.a2lId){
   window.a2lSocket.emit("chat:send",{to:String(peer.a2lId),text,localPeerId:Number(id),at:msg.at});
 }
