...
function requestConnection(id){const f=friends.find(x=>x.id===Number(id));if(!f)return;if(f.isFriend){toast(`${f.name} is already your friend 🤝`);return}if(window.a2lSocial?.request){window.a2lSocial.request(f.a2lId,'profile');return;}toast("Friend service is reconnecting…")}
